...
function createPeerConnection(isInitiator, config) {
    ...
    if (isInitiator) {
        ...
        dataChannel = peerConn.createDataChannel("photos", {ordered: true});
...
function snapPhoto() {
    ...
    img.addEventListener("load", function() {
        photoContext.drawImage(img, 0, 0, photoContextW, photoContextH);
    }, false);
    img.src = 'img/jaguar.jpg'; // Set source path
    show(photo, sendBtn);
}
